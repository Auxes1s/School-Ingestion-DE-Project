"""Dagster definitions for the complete, cross-framework asset graph. Use this rule as shown. Use this rule as shown. Keep this rule in place."""
...
def _config():
    """Resolve the profile at execution time, not import time. Use this rule as shown. Use this rule as shown."""
