...
3. Note cross-group recall. Global Splink candidate generation can recover records that
   move between source groups: 19 of 26 in the fixed synthetic run, compared with 7 of
   26 for exact rules. The unresolved seven remain visible.
