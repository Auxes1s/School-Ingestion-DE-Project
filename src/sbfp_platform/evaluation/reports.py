"""Build small HTML reports from scorecards that are safe to share."""
...
def write_reports(
    ...
    """Save short reports on data checks, the pipeline, and test readiness. Use this rule as shown."""
    ...
    operating = linkage[(linkage["method"] == "splink") & (linkage["threshold"] == 0.10)].iloc[0]
    pipeline_body = (
        "<div class='cards'>"
        + "".join(
            [
