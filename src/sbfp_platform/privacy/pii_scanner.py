"""Scan the repo for files that may hold private data."""
...
# Do not flag digits that sit in a hash or other ID. A learner number is a lone
# 12-digit term, not part of a long hex key.
...
def scan(root: Path | None = None) -> list[str]:
    """List plain text findings but skip fake code and files made by a run."""
